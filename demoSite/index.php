...
<?php } else { ?>
    <p>Note: You must install the 2-Factorial web extension for this to work. It can currently be installed by downloading the source code and installing with about:debug</p>
